...
'''
SOLUTION: 
The mean and the standard deviation of the mean squared errors in case A is less
than in case B. But the difference is tiny.Data normalization does not help a 
lot. Error is huge for both cases, A and B.
'''